...
public class LightTest {
	...
	public void lightingTest() {
		...
		scene.addIntersectable(triangle1, triangle2);
	...
	public void shadowTest() {
		...
		scene.setBackground(Color.BLACK);
		Sphere sphere = new Sphere(new Color(0, 0, 100), new Material(0.5, 0.5, 300), 50, new Point3D(0, 0, 100));
		Triangle triangle = new Triangle(new Color(0, 0, 100), new Material(0.5, 0.5, 300), new Point3D(-30, 25, 40),
				new Point3D(-30, 15, 40), new Point3D(-20, 25, 40));
		scene.addIntersectable(sphere, triangle);
		...
		triangle = new Triangle(new Color(0, 0, 100), new Material(0.5, 0.5, 300), new Point3D(-30, 20, 40),
		...
		triangle = new Triangle(new Color(0, 0, 100), new Material(0.5, 0.5, 300), new Point3D(-20, 20, 40),
		...
		Triangle triangle1 = new Triangle(new Color(0, 0, 100), new Material(0.5, 0.5, 300), new Point3D(-30, 20, 40),
				new Point3D(-30, 10, 40), new Point3D(-20, 20, 40));

		// point light
		scene.addIntersectable(sphere, triangle1);
	...
	public void transparencyTest() {
		...
		scene.setAmbient(new AmbientLight(new Color(255, 255, 255), 0));
		scene.setBackground(Color.BLACK);
		Sphere sphere1 = new Sphere(new Color(0, 0, 100), new Material(0.5, 0.5, 300, 0, 0.3), 30,
				new Point3D(0, 0, 60));
		Sphere sphere2 = new Sphere(new Color(0, 0, 100), new Material(0.5, 0.5, 300, 0, 1), 10, new Point3D(0, 0, 60));
		scene.addIntersectable(sphere1, sphere2);
	...
	public void testGlossySurface() {
		...
		scene.setAmbient(new AmbientLight(new Color(255, 255, 255), 0));
		scene.setBackground(Color.BLACK);
		Plane plane = new Plane(new Color(0, 0, 0), new Material(0.5, 0.5, 300, 0.4, 0, 0.05, 0), //
		...
		Sphere sphere3 = new Sphere(new Color(0, 0, 20), new Material(0.5, 0.5, 1200, 0.5, 0), //
				20, new Point3D(-75, -33, 140)); // sphere 3
		Sphere sphere4 = new Sphere(new Color(0, 0, 20), new Material(0.5, 0.5, 1200, 0.5, 0), //
...
//				, square1, square2, square3, square4 //
		...
		ImageWriter imageWriter = new ImageWriter("Glossy test", 200, 150, 600, 450);
		List<LightSource> lights = new ArrayList<LightSource>();
		lights.add(point_light);
		scene.setLights(lights);
		Render render = new Render(imageWriter, scene);
	...
	public void testMatteGlass() {
		...
		// window for sphere 1
		Polygon square1 = new Polygon(new Color(0, 0, 0), new Material(0.1, 0.1, 300, 0, 0.8, 0, 0.1), //
				new Point3D(75, 20, 100), new Point3D(36, 20, 100), new Point3D(36, -40, 100),
				new Point3D(75, -40, 100));
		// window for sphere 2
		Polygon square2 = new Polygon(new Color(0, 0, 0), new Material(0.1, 0.1, 300, 0, 0.8, 0, 0.5), //
				new Point3D(1, 20, 100), new Point3D(34, 20, 100), new Point3D(34, -40, 100), new Point3D(1, -40, 100));
		// window for sphere 3
		Polygon square3 = new Polygon(new Color(0, 0, 0), new Material(0.1, 0.1, 300, 0, 0.8, 0, 1), //
				new Point3D(-75, 20, 100), new Point3D(-36, 20, 100), new Point3D(-36, -40, 100),
				new Point3D(-75, -40, 100));
		// window for sphere 4
		...
		ImageWriter imageWriter = new ImageWriter("Matte test", 200, 150, 600, 450);
		List<LightSource> lights = new ArrayList<LightSource>();
		lights.add(point_light);
		scene.setLights(lights);
		Render render = new Render(imageWriter, scene);
	...
	public void testShadowLight() {
		Scene scene = new Scene("shadow light test");
		scene.setCamera(new Camera(new Point3D(0, 0, -1000), new Vector(0, -1, 0), new Vector(0, 0, 1)));
		scene.setDistance(1000);
		scene.setAmbient(new AmbientLight(new Color(255, 255, 255), 0));
		scene.setBackground(Color.BLACK);
